...
class RdmaRealEndpointsTest : public ::testing::Test {
  protected:
    ...
    rx_request.local_addr = {.ip = "192.168.1.25", .port = "8002"};
    rx_request.remote_addr = {.ip = "192.168.1.25", .port = "8002"};
    ...
    tx_request.local_addr = {.ip = "192.168.1.25", .port = "8002"};
    tx_request.remote_addr = {.ip = "192.168.1.25", .port = "8002"};
